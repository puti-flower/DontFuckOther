...
call_nonce = execjs.compile(nonce_js)
call_xyz = execjs.compile(xyz_js)

rank_name = "文化"
rank_name_group = "生活"
start = "2022-10-09"
end = "2022-10-09"
nonce = call_nonce.call("getNonce")

h = (
    f"/xdnphb/main/v1/day/rank?AppKey=joker&"
    f"end={end}&rank_name={rank_name}&rank_name_group={rank_name_group}&"
    f"start={start}&nonce=" + nonce
)
xyz = call_xyz.call("b", h)
